...
pub use ops::{
    ...
    status_with_backend, status_with_options, StatusOptions,
};
#[cfg(feature = "serde")]
...
#[cfg(feature = "serde")]
pub use ops::{pull, pull_files, PullResult, PullSummary};
#[cfg(feature = "serde")]
pub use ops::{push, push_files, PushResult, PushSummary};
#[cfg(feature = "serde")]
pub use ops::{rollback, rollback_with_backend, RollbackResult, RollbackTarget};
#[cfg(feature = "serde")]
pub use ops::{verify, verify_with_backend, VerifyResult, VerifySummary};
