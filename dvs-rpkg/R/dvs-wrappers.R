...
# Generated from Rust fn `dvs_get` (lib.rs:291:15)
...
# Generated from Rust fn `dvs_init` (lib.rs:138:15)
...
# Generated from Rust fn `dvs_status` (lib.rs:235:15)
...
dvs_status_impl <- function(files = character(0), recursive = NULL, current = NULL, absent = NULL, unsynced = NULL) {
  stopifnot(
  ...
  .val <- .Call(C_dvs_status, .call = match.call(), files, recursive, current, absent, unsynced)
  if (inherits(.val, "rust_error_value") && isTRUE(attr(.val, "__rust_error__"))) {
    stop(structure(
      class = c("rust_error", "simpleError", "error", "condition"),
      list(message = .val$error, call = .val$call %||% sys.call(), kind = .val$kind)
...
# Generated from Rust fn `dvs_set_threads` (lib.rs:335:15)
