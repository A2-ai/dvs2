...
# Generated from Rust fn `dvs_add` (lib.rs:67:8)
...
# Generated from Rust fn `dvs_get` (lib.rs:148:8)
...
# Generated from Rust fn `dvs_init` (lib.rs:32:8)
...
# Generated from Rust fn `num_cpus` (lib.rs:181:8)
#' @title Detect cores for parallelism
#' @description Returns the number of logical cores currently available in the system.
#' @note Unlike `parallel::detectCores()`, `num_cpus()` respects cgroups.
#' @source Generated by miniextendr from Rust fn `num_cpus`
#' @export
num_cpus <- function() {
  .val <- .Call(C_num_cpus, .call = match.call())
  if (inherits(.val, "rust_error_value") && isTRUE(attr(.val, "__rust_error__"))) {
    stop(structure(
      class = c("rust_error", "simpleError", "error", "condition"),
      list(message = .val$error, call = .val$call %||% sys.call(), kind = .val$kind)
...
# Generated from Rust fn `dvs_status` (lib.rs:109:8)
