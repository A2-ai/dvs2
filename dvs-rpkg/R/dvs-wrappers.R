...
# Generated from Rust impl `ProgressBarCallback` (lib.rs:57:6)
...
#' @description Tick the wrapped R callback.
#' @name ProgressBarCallback$tick
#' @rdname ProgressBarCallback
#' @source Generated by miniextendr from `ProgressBarCallback::tick`
ProgressBarCallback$tick <- function() {
  .val <- .Call(C_ProgressBarCallback__tick, .call = match.call(), self)
  if (inherits(.val, "rust_error_value") && isTRUE(attr(.val, "__rust_error__"))) {
    stop(structure(
      class = c("rust_error", "simpleError", "error", "condition"),
      list(message = .val$error, call = .val$call %||% sys.call(), kind = .val$kind)
...
# Generated from Rust fn `dvs_add` (lib.rs:164:15)
...
#' @param progress_callback (no documentation available)
...
# Generated from Rust fn `dvs_init` (lib.rs:129:15)
...
# Generated from Rust fn `dvs_status` (lib.rs:231:15)
