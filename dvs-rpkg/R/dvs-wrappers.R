...
# ProgressBarCallback::new (120:12)
...
# Generated from Rust fn `dvs_add` (lib.rs:211:15)
...
# Generated from Rust fn `dvs_get` (lib.rs:438:15)
...
# Generated from Rust fn `dvs_init` (lib.rs:160:15)
...
# Generated from Rust fn `dvs_status` (lib.rs:296:15)
...
# Generated from Rust fn `dvs_version` (lib.rs:496:8)
...
# Generated from Rust fn `dvs_set_threads` (lib.rs:482:15)
...
# Generated from Rust fn `format_byte_size` (lib.rs:490:8)
...
# Generated from Rust fn `dvs_set_log_level` (lib.rs:513:15)
#' @title Set the Rust-core log level filter
#' @description Routes Rust `log` crate messages to R's console. The R wrapper takes a `level` character (validated against the canonical lowercase names from `log::LevelFilter`) and converts to the matching variant before calling this function.
#' @param level Character string giving the desired log level.
#' @keywords internal
#' @source Generated by miniextendr from Rust fn `dvs_set_log_level`
dvs_set_log_level_impl <- function(level = c("off", "error", "warn", "info", "debug", "trace")) {
  .__mx_choices_level <- .Call(C_dvs_set_log_level__match_arg_choices__level, .call = match.call())
  level <- if (is.factor(level)) as.character(level) else level
  level <- base::match.arg(level, .__mx_choices_level)
  .val <- .Call(C_dvs_set_log_level, .call = match.call(), level)
  if (inherits(.val, "rust_error_value") && isTRUE(attr(.val, "__rust_error__"))) {
    stop(structure(
      class = c("rust_error", "simpleError", "error", "condition"),
      list(message = .val$error, call = .val$call %||% sys.call(), kind = .val$kind)
