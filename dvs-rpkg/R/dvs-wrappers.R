...
# Generated from Rust fn `dvs_add` (lib.rs:206:15)
...
# Generated from Rust fn `dvs_get` (lib.rs:485:15)
...
# Generated from Rust fn `dvs_init` (lib.rs:158:15)
...
# Generated from Rust fn `dvs_status` (lib.rs:299:15)
...
# Generated from Rust fn `dvs_version` (lib.rs:556:8)
...
# Generated from Rust fn `dvs_audit_log` (lib.rs:376:15)
#' @title Materialize the audit log as a data frame
#' @description Reads the audit log of the DVS repository containing the working directory and returns one row per entry. The column structure is inherited directly from `dvs::audit::AuditEntry`'s serde representation, so the rpkg never reaches into the dvs crate's internal types. The `action` enum currently surfaces as a nested list-column. Flattening it through serde without re-encoding dvs internals is tracked as miniextendr#1056, with a builder-based alternative in miniextendr#1055.
...
#' @keywords internal
#' @source Generated by miniextendr from Rust fn `dvs_audit_log`
dvs_audit_log_impl <- function(paths = character(0)) {
  .val <- .Call(C_dvs_audit_log, .call = match.call(), paths)
  if (inherits(.val, "rust_condition_value") && isTRUE(attr(.val, "__rust_condition__"))) return(.miniextendr_raise_condition(.val, sys.call()))
  .val
}

# Generated from Rust fn `dvs_set_threads` (lib.rs:539:15)
...
# Generated from Rust fn `format_byte_size` (lib.rs:547:8)
...
# Generated from Rust fn `set_dvs_log_level` (lib.rs:585:8)
