...
# Generated from Rust impl `ProgressBarCallback` (lib.rs:121:6)
...
# ProgressBarCallback::new (123:12)
...
# Generated from Rust fn `dvs_add` (lib.rs:214:15)
...
# Generated from Rust fn `dvs_init` (lib.rs:163:15)
...
# Generated from Rust fn `dvs_version` (lib.rs:499:8)
...
# Generated from Rust fn `dvs_set_threads` (lib.rs:485:15)
...
# Generated from Rust fn `format_byte_size` (lib.rs:493:8)
...
# Generated from Rust fn `dvs_set_log_level` (lib.rs:512:15)
#' @title Set the Rust-core log level filter
#' @description Routes Rust `log` crate messages to R's console. Valid levels are "error", "warn", "info", "debug", "trace", and "off". Invalid strings default to "info". The default at package load is "info".
#' @param level Character string giving the desired log level.
#' @keywords internal
#' @source Generated by miniextendr from Rust fn `dvs_set_log_level`
dvs_set_log_level_impl <- function(level) {
  stopifnot(
