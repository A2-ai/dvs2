...
pub struct GeneratedBy {
    ...
    #[cfg_attr(feature = "serde", serde(default = "default_tool_name", skip_serializing_if = "is_default_tool"))]
    pub tool: String,
}
...
impl Config {
    ...
    /// - `serde` only: JSON format (fallback)
    ...
    #[cfg(all(feature = "serde", not(feature = "yaml-config"), not(feature = "toml-config")))]
    pub fn load(path: &std::path::Path) -> Result<Self, crate::DvsError> {
        let contents = fs::read_to_string(path)?;
